            ...
            <div className="content">
                <section className="servicesmain">
                    <div className="servicesupper">
                        <h4 className="serviceshead">Services</h4>
                        <div className="servicesbtns">
                            ...
                            <Link to="/clinic/addservice" className="addbtn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <div className="servicescardsmain">
                                <div className="servicecard">
                                    ...
                                    <div className="servicecardimg">
                                        <img src="\assets\dummyassets\service.png" alt="innerserviceimg" className="innerserviceimg" />
                                    </div>
                                    <h6 className="servicecardhead">Dermatology Clinic</h6>
                                    <p className="servicecardpara">Lorem ipsum dolor sit amet consectetur. Cursus fermentum eget et lectus in dignissim. Dui duis eros arcu pulvinar nunc sollicitudin nulla quam.</p>
                                </div>
                                <div className="servicecard">
                                    <Dropdown align='end'>
                                        <Dropdown.Toggle variant="success" id="dropdown-basic">
                        ...
                        <div className="servicestablemain">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h6 className="nametd">Dermatology Clinic</h6>
                                        </td>
                                        <td>
                                            <div className="servicecardimg">
                                                <img src="\assets\dummyassets\service.png" alt="innerserviceimg" className="innerserviceimg" />
                                        ...
                                        <td>
                                            <p className="descriptionpara">Lorem ipsum dolor sit amet consectetur. Cursus fermentum eget et lectus in dignissim Lorem ipsum dolor sit amet consectetur. Cursus fermentum eget et lectus in dignissim</p>
                                        </td>
                                        <td>
                                            <Dropdown align='end'>
                                                <Dropdown.Toggle variant="success" id="dropdown-basic">
