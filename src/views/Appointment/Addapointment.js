        ...
        <>
            <div className="content">
                <section className="addservice">
                    <h4 className="addservicehead">Add an appointment</h4>
                    <div className="addpatientsmain">
                        <div className="addpatientinner">
                            <p className="addpatientpara">Specialty</p>
                            <Dropdown>
                                <Dropdown.Toggle id="dropdown-basic">
                                    {selectedItem ? <><h6>{selectedItem}</h6></> : "Select the specialty"}
                        ...
                        <div className="addpatientinner">
                            <p className="addpatientpara">Doctor</p>
                            <Dropdown>
                                <Dropdown.Toggle id="dropdown-basic">
                    ...
                    <p className="patientdetailpara">Patient Details</p>
                    <div className="addpatientsmain">
                    <div className="addpatientinner">
                        ...
                        <div className="addpatientinner">
                            ...
                            <input type="text" className="addpatientinput" placeholder='Enter the mobile number' />
                        </div>
                        <div className="addpatientinner">
                    ...
                    <div className="addservicebtns">
                        <Link to="/clinic/appointment" className="whitebtn">Cancel</Link>
